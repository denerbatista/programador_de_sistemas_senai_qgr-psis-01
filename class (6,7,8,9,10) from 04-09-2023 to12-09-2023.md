...
Neste exercício, você deve criar um programa que permita ao usuário inserir uma lista de números e, em seguida, ordenar essa lista em ordem crescente ou decrescente, conforme a escolha do usuário.
